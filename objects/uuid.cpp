 ...
 *
 * Some person randomly generated these using a generator app.
 * These were generated by the original author for a MIDI application.
 * You should generate new ones to prevent remotely possible conflict with the original application.
 *
 * The bytes need to be in reverse order to match the UUID from the spec
 * Stored in little endian, meaning that the Least Significant Byte is stored at lower address.
 */

#define MyServiceBaseUUID  {0x00, 0xC7, 0xC4, 0x4E, 0xE3, 0x6C, 0x51, 0xA7, 0x33, 0x4B, 0xE8, 0xED, 0x5A, 0x0E, 0xB8, 0x03}
#define MyServiceShortUUID 0x0E5A

#define MyCharacteristicBaseUUID {0xF3, 0x6B, 0x10, 0x9D, 0x66, 0xF2, 0xA9, 0xA1, 0x12, 0x41, 0x68, 0x38, 0xDB, 0xE5, 0x72, 0x77}
#define MyCharacteristicShortUUID 0xE5DB
...
ble_uuid128_t myServiceLongUUID = MyServiceBaseUUID;

ble_uuid_t myCharacteristicUUIDRepresentative;
ble_uuid128_t myCharacteristicLongUUID = MyCharacteristicBaseUUID;
